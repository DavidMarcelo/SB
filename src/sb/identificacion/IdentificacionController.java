...
public class IdentificacionController implements Initializable {
    ...
    public void identificarHuella() throws IOException, SQLException, ParseException{        
     ...
     try {
       ...
       //e indica el nombre de la persona que coincidió.
        if (result.isVerified()){
            ...
            String fechaV = String.valueOf(venimiento);
            System.out.println("fechaV: "+fechaV);
            int tot = fecha.compareTo(fechaV);
            System.out.println("tot: "+tot);
            if (tot<0){//La fecha es menor
                System.out.println("menor");
                //System.out.println("bienvenido" + " " + nombre);
                label_name.setTextFill(Color.YELLOW);
                label_name.setText("Bienvenido"+" "+nombre);
                label_end.setTextFill(Color.YELLOW);
                label_end.setText("Su mensualidad vence el:"+" "+venimiento);
            }else if (tot>0){//La fecha es mayor
                System.out.println("mayor");
                //System.out.println("bienvenido" + " " + nombre);
                label_name.setTextFill(Color.RED);
                label_name.setText("Bienvenido"+" "+nombre);
                label_end.setTextFill(Color.RED);
                label_end.setText("Su mensualidad venció el:"+" "+venimiento);
            }else{
                //System.out.println("bienvenido" + " " + nombre);
                label_name.setTextFill(Color.YELLOW);
                label_name.setText("Bienvenido"+" "+nombre);
                label_end.setTextFill(Color.YELLOW);
                label_end.setText("Su mensualidad vence hoy:"+" "+venimiento);
            }
            //this.label_end.setBackground(Color.RED);
            //Fecha
            
            //Hora
            DateFormat hf = new SimpleDateFormat("HH:mm:ss");
            String hora = String.valueOf(hf.format(new Date()));
            //System.out.println("fecha: "+ff.format(new Date()));
            //System.out.println("Fecha String: "+fecha+" "+hora);
            String contenido = hora+" "+nombre+" "+fecha;
            System.out.println(contenido);
            //Escribir los reportes en txt
            try{
                File file = new File("reporte"+fecha+".txt");
...
//                        EnviarTexto("El dedo ha sido quitado del Lector de Huella");
    ...
    public void reinicio(Event event) throws IOException{
